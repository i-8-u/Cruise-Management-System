...
const DinnerOrders = () => {
  ...
  const dinnerOrders = getOrdersByType("Dinner")

  const filteredOrders = dinnerOrders.filter((order) => {
    // Apply search filter
    const searchMatch =
      searchTerm === "" ||
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-pink-500">Dinner Orders</h1>
            <p className="text-gray-600">Manage and prepare dinner orders for voyagers</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow mb-6">
            ...
            {filteredOrders.length > 0 ? (
              ...
              <div className="text-center py-10">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">No dinner orders found</h3>
                <p className="mt-1 text-sm text-gray-500">No dinner orders match your current filters.</p>
              </div>
            )}
          </div>
        </main>
