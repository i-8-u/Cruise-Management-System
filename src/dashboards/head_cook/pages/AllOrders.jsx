  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        ...
        const q = query(ordersRef, where("orderCategory", "==", "catering"))
        ...
        ordersSnap.forEach((doc) => {
          ...
          const orderDate = createdAt?.toLocaleDateString() || "N/A"
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Manage and prepare all catering orders for voyagers</p>
          </div>
