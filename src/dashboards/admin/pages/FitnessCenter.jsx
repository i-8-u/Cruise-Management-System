import { Calendar, Dumbbell, Ticket, Users } from "lucide-react"
...
function MovieTickets() {
  ...
  return (
    <div>
    <Header title="Fitness Bookings" subtitle="Manage Fitness Bookings"/>
    <div className="space-y-6">
        <div className="flex items-center">
          <Dumbbell className="w-6 h-6 text-pink-500 mr-2" />
          <h2 className="text-xl font-bold text-gray-800">All Fitness Bookings</h2>
        </div>
